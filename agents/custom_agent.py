...
class Neighborhood(): # goal: mediates all access to glyphs by advisors
    ...
    def __init__(self, absolute_player_location, observation, dcoord, level_map, character, last_movement_action, previous_glyph_on_player, latest_monster_death, failed_moves_on_square, feedback):
        ...
        #########################################
        self.n_threat = self.threat_map.melee_n_threat[neighborhood_view]
        self.ranged_n_threat = self.threat_map.ranged_n_threat[neighborhood_view]
        self.damage_threat = self.threat_map.melee_damage_threat[neighborhood_view]
        self.ranged_damage_threat = self.threat_map.ranged_damage_threat[neighborhood_view]
