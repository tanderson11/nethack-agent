...
small_advisors = [
    ...
    AdvisorLevel({DesirableObjectMoveAdvisor: 1,}, skip_probability=0.25),
    AdvisorLevel({VisitUnvisitedSquareAdvisor: 1}),
    AdvisorLevel({TakeDownstairsAdvisor: 1,}),
    AdvisorLevel({TravelToDownstairsAdvisor: 1,}, skip_probability=0.80),
    NoUnvisitedWalkableInFullVisionAdvisorLevel({SearchUndersearchedAdvisor: 1}, skip_probability=0.25),
    AdvisorLevel({VisitUndersearchedSquareByNoveltyAdvisor: 1}),
    AdvisorLevel({
